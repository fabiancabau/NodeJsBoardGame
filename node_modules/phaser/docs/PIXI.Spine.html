...
<head>
	<meta charset="utf-8">
	<title>Phaser Class: Spine</title>
...
<div class="container-fluid">
	...
	<!--<h1 class="page-title">Class: Spine</h1>-->
<section>
...
<dt>
    <h4 class="name "
        id="Spine"><span class="type-signature"></span>new Spine<span class="signature">(url)</span><span class="type-signature"></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>A class that enables the you to import and run your spine animations in pixi.
Spine animation data needs to be loaded using the PIXI.AssetLoader or PIXI.SpineLoader before it can be used by this class
See example 12 (<a href="http://www.goodboydigital.com/pixijs/examples/12/">http://www.goodboydigital.com/pixijs/examples/12/</a>) to see a working example and check out the source</p>
    </div>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The url of the spine anim file to be used</p></td>
        </tr>
...
<dl class="details">
    ...
    <a href="PIXISpine.js.html">pixi/extras/PIXISpine.js</a>, <a href="PIXISpine.js.html#sunlight-1-line-62">line 62</a>
    </dt>
...
<dt>
    <h4 class="name "
        id="autoUpdate"><span class="type-signature"></span>autoUpdate<span class="type-signature"> :Boolean</span></h4>
...
<dd>
    ...
    <div class="description">
        <p>If this flag is set to true, the spine animation will be autoupdated every time
the object id drawn. The down side of this approach is that the delta time is
automatically calculated and you could miss out on cool effects like slow motion,
pause, skip ahead and the sorts. Most of these effects can be achieved even with
autoupdate enabled but are harder to achieve.</p>
    </div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="PIXISpine.js.html">pixi/extras/PIXISpine.js</a>, <a href="PIXISpine.js.html#sunlight-1-line-124">line 124</a>
    </dt>
...
<dt>
    <h4 class="name "
        id="update"><span class="type-signature"></span>update<span class="signature">(dt)</span><span class="type-signature"></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>Update the spine skeleton and its animations by delta time (dt)</p>
    </div>
...
<span class="param-type">Number</span>
            ...
            <td class="description last"><p>Delta time. Time by which the animation should be updated</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="PIXISpine.js.html">pixi/extras/PIXISpine.js</a>, <a href="PIXISpine.js.html#sunlight-1-line-147">line 147</a>
    </dt>
...
<dl class="details">
    ...
    <a href="DisplayObject.js.html">pixi/display/DisplayObject.js</a>, <a href="DisplayObject.js.html#sunlight-1-line-606">line 606</a>
		...
		on Wed Dec 03 2014 10:31:24 GMT-0000 (GMT) using the <a href="https://github.com/terryweiss/docstrap">DocStrap template</a>.
		</span>
				</footer>
			</div>
